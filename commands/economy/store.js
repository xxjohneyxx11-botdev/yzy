...
module.exports = {
    ...
    execute(client, message, args) {
        ...
        if (item === 'slides') {
            ...
            if (10000 > money) return message.reply('you dont have enough 💵 to do that!')
            ...
            if (25000 > money) return message.reply('you dont have enough 💵 to do that!')
            ...
            if (45000 > money) return message.reply('you dont have enough 💵 to do that!')
            ...
            if (70000 > money) return message.reply('you dont have enough 💵 to do that!')
            ...
            if (150000 > money) return message.reply('you dont have enough 💵 to do that!')
            ...
            if (200000 > money) return message.reply('you dont have enough 💵 to do that!')
            ...
            if (250000 > money) return message.reply('you dont have enough 💵 to do that!')
            ...
            if (300000 > money) return message.reply('you dont have enough 💵 to do that!')
            ...
            if (10000000 > money) return message.reply('you dont have enough 💵 to do that!')
            ...
            return message.reply(`do \`${prefix}store (item)\` to buy an item`)
        }
